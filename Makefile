...
AVRMEM = $(SIZE) -C --mcu=$(MCU) $(TARGET).elf
...
program: $(TARGET).hex $(TARGET).eep
	$(AVRDUDE) $(AVRDUDE_FLAGS) $(AVRDUDE_WRITE_EFUSE) $(AVRDUDE_WRITE_HFUSE) $(AVRDUDE_WRITE_LFUSE) $(AVRDUDE_WRITE_FLASH) $(AVRDUDE_WRITE_EEPROM)
